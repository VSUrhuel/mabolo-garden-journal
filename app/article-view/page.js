      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage href="/article-view">Articles</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        {/* Button - View Draft */}
        <Link href="/draft-view" passHref>
          <Button variant="outline" className="ml-2 whitespace-nowrap">
            <span className="inline md:hidden">View Draft</span>
            <span className="hidden md:inline">Go to Drafts</span>
          </Button>
        </Link>
      </div>
