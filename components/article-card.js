    ...
    <div>
      <Card className="w-full bg-white dark:bg-gray-800 shadow-md hover:shadow-lg transition-all duration-300 ease-in-out overflow-hidden group">
        ...
        <CardContent className="px-3 pb-3 md:px-4 md:pb-4">
          <p className="text-gray-600 text-xs dark:text-gray-100 line-clamp-3 md:text-sm">
            {textContent}
          </p>
        </CardContent>
        ...
        <CardFooter className="px-3 pb-3 flex justify-between items-end md:px-4 md:pb-4">
          <div></div>
          <button className="text-blue-600 dark:text-green-400 hover:text-blue-800 dark:hover:text-green-300 font-medium transition-colors flex items-center gap-1 text-xs md:text-sm">
            Read More
            <svg
