import DeployButton from "@/components/common/deploy-button";
import { EnvVarWarning } from "@/components/common/env-var-warning";
...
export const metadata = {
  ...
  title: "Mabolo Garden Journal",
  description: "A personal garden journal to track your plants and progress.",
};
    ...
    <html lang="en" className={geistSans.className} suppressHydrationWarning>
      <body className="bg-background text-foreground">
        ...
        >
          ...
          >
            <div className="flex-1 w-full flex flex-col gap-0 md:gap-0 items-center">
